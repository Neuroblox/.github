...
> **New Release** :tada:
> 
> The Neuroblox Team is happy to announce the Neuroblox GUI 0.9 beta release.  For GUI installation instructions, go to [Neuroblox.jl](https://github.com/Neuroblox/Neuroblox.jl)
